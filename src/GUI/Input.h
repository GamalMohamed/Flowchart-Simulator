...
public:
	...
	string GetValue(Output* pO) const;	// Reads a double value from the user 

	string GetString(Output* pO) const ; //Returns a string entered by the user

	ActionType GetUserAction(int&,int&) const; //Reads the user click and maps it to an action
